...
export const ConnectionHistoryWorkspace = ({
  ...
  }, [active, onLoadOverview, range, t.connectionHistoryNoHosts])
  ...
  }, [active, onLoadHostDetails, range, selectedHistoryKey, t.connectionHistoryNoSessions])
          ...
          <div className="space-y-4">
            {displayedDetails?.host ? (
              ...
              <div className={`${sectionClass} p-6 text-sm ${isDark ? 'text-slate-300' : 'text-slate-600'}`}>
                {active && (overview === null || hostListOverview === null)
                  ? '…'
                  : t.connectionHistoryNoHostsDescription}
              </div>
            )}
